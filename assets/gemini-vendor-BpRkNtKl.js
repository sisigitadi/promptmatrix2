 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ const X = "https://generativelanguage.googleapis.com",
  Q = "v1beta",
  z = "0.24.1",
  Z = "genai-js";
var C;
...
class tt {
  ...
  toString() {
    var e, n;
    const s =
      ((e = this.requestOptions) === null || e === void 0
        ? void 0
        : e.apiVersion) || Q;
...
function et(t) {
  const e = [];
  return (
    t != null && t.apiClient && e.push(t.apiClient),
    e.push(`${Z}/${z}`),
    e.join(" ")
  );
}
async function nt(t) {
  ...
  (n.append("Content-Type", "application/json"),
    n.append("x-goog-api-client", et(t.requestOptions)),
  ...
  if (s) {
    if (!(s instanceof Headers))
      try {
        ...
        throw new E(
          `unable to convert customHeaders value ${JSON.stringify(s)} to Headers: ${o.message}`,
        );
      }
    for (const [o, i] of s.entries()) {
      ...
      if (o === "x-goog-api-client")
        throw new E(
          `Header name ${o} can only be set using the apiClient field`,
        );
      n.append(o, i);
    }
  }
...
async function st(t, e, n, s, o, i) {
  ...
  return {
    url: a.toString(),
    fetchOptions: Object.assign(Object.assign({}, rt(i)), {
      method: "POST",
      headers: await nt(a),
      body: o,
    }),
...
async function at(t, e) {
  ...
  try {
    ...
    ((n = o.error.message),
      o.error.details &&
        ((n += ` ${JSON.stringify(o.error.details)}`), (s = o.error.details)));
  } catch {}
  throw new q(
    `Error fetching from ${e.toString()}: [${t.status} ${t.statusText}] ${n}`,
    t.status,
    t.statusText,
    s,
  );
...
function rt(t) {
  const e = {};
  if (
    (t == null ? void 0 : t.signal) !== void 0 ||
    (t == null ? void 0 : t.timeout) >= 0
  ) {
...
function ct(t) {
  ...
  if (
    !(
      (n =
        (e = t.candidates) === null || e === void 0 ? void 0 : e[0].content) ===
        null || n === void 0
    ) &&
    n.parts
  )
    for (const a of (o =
      (s = t.candidates) === null || s === void 0 ? void 0 : s[0].content) ===
      null || o === void 0
      ? void 0
      : o.parts)
...
const dt = [R.RECITATION, R.SAFETY, R.LANGUAGE];
function S(t) {
...
function g(t) {
  ...
  if ((!t.candidates || t.candidates.length === 0) && t.promptFeedback)
    ((o += "Response was blocked"),
      !((e = t.promptFeedback) === null || e === void 0) &&
        e.blockReason &&
        (o += ` due to ${t.promptFeedback.blockReason}`),
      !((n = t.promptFeedback) === null || n === void 0) &&
        n.blockReasonMessage &&
        (o += `: ${t.promptFeedback.blockReasonMessage}`));
  else if (!((s = t.candidates) === null || s === void 0) && s[0]) {
    const i = t.candidates[0];
    S(i) &&
      ((o += `Candidate was blocked due to ${i.finishReason}`),
      i.finishMessage && (o += `: ${i.finishMessage}`));
  }
  return o;
}
function p(t) {
...
function lt(t, e, n) {
  ...
  function d(l) {
    l.value instanceof p
      ? Promise.resolve(l.value.v).then(h, _)
      : v(i[0][2], l);
  }
  function h(l) {
    r("next", l);
 ...
 */ const $ = /^data\: (.*)(?:\n\n|\r\r|\r\n\r\n)/;
function ut(t) {
  const e = t.body.pipeThrough(new TextDecoderStream("utf8", { fatal: !0 })),
    n = gt(e),
    [s, o] = n.tee();
  return { stream: ht(s), response: ft(o) };
}
async function ft(t) {
  const e = [],
    n = t.getReader();
        ...
        return e
          ...
          .catch((a) => {
            ...
            throw (
              (r.stack = a.stack),
              r.name === "AbortError"
                ? (r = new P("Request aborted when reading from the stream"))
                : (r = new u("Error reading from the stream")),
              r
            );
          });
      }
...
function Et(t) {
  const e = t[t.length - 1],
    n = { promptFeedback: e == null ? void 0 : e.promptFeedback };
  for (const s of t) {
    if (s.candidates) {
      let o = 0;
      for (const i of s.candidates)
        if (
          ...
          n.candidates[o] || (n.candidates[o] = { index: o }),
          (n.candidates[o].citationMetadata = i.citationMetadata),
          (n.candidates[o].groundingMetadata = i.groundingMetadata),
          (n.candidates[o].finishReason = i.finishReason),
          (n.candidates[o].finishMessage = i.finishMessage),
          (n.candidates[o].safetyRatings = i.safetyRatings),
          i.content && i.content.parts)
        ) {
          ...
          for (const r of i.content.parts)
            (r.text && (a.text = r.text),
              r.functionCall && (a.functionCall = r.functionCall),
              r.executableCode && (a.executableCode = r.executableCode),
              r.codeExecutionResult &&
                (a.codeExecutionResult = r.codeExecutionResult),
              Object.keys(a).length === 0 && (a.text = ""),
              n.candidates[o].content.parts.push(a));
        }
      o++;
    }
 ...
 */ async function V(t, e, n, s) {
  const o = await y(e, C.STREAM_GENERATE_CONTENT, t, !0, JSON.stringify(n), s);
  return ut(o);
}
async function J(t, e, n, s) {
  const i = await (
    await y(e, C.GENERATE_CONTENT, t, !1, JSON.stringify(n), s)
  ).json();
  return { response: N(i) };
}
/**
...
function Ct(t) {
  ...
  if (!s && !o) throw new u("No content is provided for sending chat message.");
  return s ? e : n;
}
function _t(t, e) {
  var n;
  let s = {
    ...
    cachedContent:
      (n = e == null ? void 0 : e.cachedContent) === null || n === void 0
        ? void 0
        : n.name,
    contents: [],
  };
...
function j(t) {
  let e;
  return (
    t.contents ? (e = t) : (e = { contents: [A(t)] }),
    t.systemInstruction && (e.systemInstruction = W(t.systemInstruction)),
    e
  );
}
function vt(t) {
...
function It(t) {
  ...
  for (const n of t) {
    ...
    if (!b.includes(s))
      throw new u(
        `Each item should include role field. Got ${s} but valid roles are: ${JSON.stringify(b)}`,
      );
    if (!Array.isArray(o))
      throw new u(
    ...
    for (const r of o) for (const d of K) d in r && (i[d] += 1);
    const a = Ot[s];
    for (const r of K)
...
class Rt {
  constructor(e, n, s, o = {}) {
    ((this.model = n),
      ...
      (this._apiKey = e),
      s != null && s.history && (It(s.history), (this._history = s.history)));
  }
  async getHistory() {
  ...
  async sendMessage(e, n = {}) {
      ...
      _ = {
        ...
        systemInstruction:
          (r = this.params) === null || r === void 0
            ...
            : r.systemInstruction,
        cachedContent:
          (d = this.params) === null || d === void 0 ? void 0 : d.cachedContent,
    ...
    return (
      (this._sendPromise = this._sendPromise
        .then(() => J(this._apiKey, this.model, _, v))
        .then((c) => {
          var f;
          if (Y(c.response)) {
            ...
            const O = Object.assign(
              { parts: [], role: "model" },
              (f = c.response.candidates) === null || f === void 0
                ? void 0
                : f[0].content,
            );
  ...
  async sendMessageStream(e, n = {}) {
    ...
    const h = A(e),
      ...
      v = Object.assign(Object.assign({}, this._requestOptions), n),
      l = V(this._apiKey, this.model, _, v);
    return (
      (this._sendPromise = this._sendPromise
        .then(() => l)
        .catch((c) => {
        ...
        .then((c) => {
          if (Y(c)) {
            ...
            f &&
              console.warn(
                `sendMessageStream() was unsuccessful. ${f}. Inspect response object for details.`,
              );
          }
        })
        .catch((c) => {
...
async function yt(t, e, n, s) {
  const o = n.requests.map((a) =>
    Object.assign(Object.assign({}, a), { model: e }),
  );
  return (
    await y(
      e,
 ...
 */ class k {
  constructor(e, n, s = {}) {
    ((this.apiKey = e),
      ...
      (this.systemInstruction = W(n.systemInstruction)),
      (this.cachedContent = n.cachedContent));
  }
  async generateContent(e, n = {}) {
    var s;
    const o = j(e),
      i = Object.assign(Object.assign({}, this._requestOptions), n);
    return J(
      this.apiKey,
      this.model,
      Object.assign(
        {
          ...
          cachedContent:
            (s = this.cachedContent) === null || s === void 0 ? void 0 : s.name,
        },
        o,
      ),
      i,
 ...
 */ class St {
  ...
  getGenerativeModelFromCachedContent(e, n, s) {
    if (!e.name) throw new E("Cached content must contain a `name` field.");
    if (!e.model) throw new E("Cached content must contain a `model` field.");
    const o = ["model", "systemInstruction"];
    for (const a of o)
      if (n != null && n[a] && e[a] && (n == null ? void 0 : n[a]) !== e[a]) {
        if (a === "model") {
          const r = n.model.startsWith("models/")
              ? n.model.replace("models/", "")
              : n.model,
            d = e.model.startsWith("models/")
              ? e.model.replace("models/", "")
              : e.model;
          if (r === d) continue;
        }
        throw new E(
          `Different value for "${a}" specified in modelParams (${n[a]}) and cachedContent (${e[a]})`,
        );
      }
