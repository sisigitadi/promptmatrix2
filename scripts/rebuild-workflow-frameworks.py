...
# Helper komponen umum untuk semua workflow automation
    ...
    return [
        {
            ...
            "options": [
                "Make.com (Integromat) - Visual Bagus",
                "N8n (Self-Hosted/Cloud) - Paling Powerful/Murah",
                "Zapier - Paling Mudah/Mahal",
                "Pipedream - Developer Focused",
                "Relay.app - Simple AI Automation"
            ],
            "description": "Platform mana yang akan Anda gunakan untuk membangun workflow ini?"
        },
        {
            "name": "COMPLEXITY",
            ...
            "type": "select",
            "options": [
                "Simple (Linear: Trigger -> Action)",
                "Moderate (Cabang/Kondisi: If/Else)",
                "Complex (Iterator/Aggregator/Array)",
                "Advanced AI Agent (Looping/Memory)"
            ]
        }
    ]
        ...
        "components": [
            {
                ...
                "type": "select",
                "options": ["Facebook Lead Ads (Instant Form)", "Google Lead Form", "Website Webhook (Elementor/WP)", "Typeform/Tally"]
            },
            {
                "name": "DESTINATION_CRM",
                "label": "Tujuan Data (Database)",
                "type": "select",
                "options": ["Google Sheets / Airtable", "HubSpot CRM", "Notion Database", "Kirim ke API Custom"]
            },
            {
                "name": "NOTIFICATION_CHANNEL",
                "label": "Channel Notifikasi/Follow-up",
                "type": "multiselect",
                "options": ["WhatsApp (Wozzap/Wati)", "Email (Gmail/SMTP)", "Slack/Telegram Alert", "SMS (Twilio)"]
            }
        ]
    },
    "KOL-AUTO-002": {
        ...
        "components": [
            {
                ...
                "type": "select",
                "options": ["Google Drive (Video/Audio File)", "YouTube RSS Feed", "Blog WordPress (Artikel Baru)", "Instagram Post"]
            },
            {
                "name": "AI_MODEL",
                "label": "Model AI Pemroses",
                "type": "select",
                "options": ["OpenAI GPT-4o", "Claude 3.5 Sonnet", "Gemini Pro", "Groq (Llama 3 - High Speed)"]
            },
            {
                "name": "TARGET_PLATFORMS",
                "label": "Platform Tujuan Posting",
                "type": "multiselect",
                "options": ["LinkedIn Personal", "Twitter/X Thread", "Instagram Caption", "WordPress Draft", "Facebook Page"]
            }
        ]
    },
    "KOL-AUTO-003": {
        ...
        "components": [
            {
                ...
                "type": "select",
                "options": ["WooCommerce (Webhook)", "Shopify", "Tokopedia/Shopee (via Scraper/3rd Party API)", "Order Online Form"]
            },
            {
                "name": "ACTIONS",
                "label": "Aksi yang Diinginkan",
                "type": "multiselect",
                "options": ["Kirim Konfirmasi WA", "Input ke Google Sheet Keuangan", "Print Label Pengiriman", "Kurangi Stok di Database", "Kirim Invoice PDF"]
            },
            {
                "name": "PAYMENT_CHECK",
                "label": "Cek Pembayaran?",
                "type": "select",
                "options": ["Ya, Cek Status Payment Gateway", "Tidak, Anggap Semua Lunas", "Ya, Cek Mutasi Bank (Moota/Cekmutasi)"]
            }
        ]
    },
    "KOL-AUTO-004": {
        ...
        "components": [
            {
                ...
                "label": "Pemicu Riset",
                "type": "select",
                "options": ["Form Request (Tally/Typeform)", "Pesan Telegram Bot", "Slack Command", "Jadwal Mingguan (Cron)"]
            },
            {
                "name": "RESEARCH_TOOLS",
                "label": "Tools Riset/Search",
                "type": "multiselect",
                "options": ["Serper.dev / SerpApi (Google Search)", "ScrapingBee / ZenRows (Scraper)", "Perplexity API", "Wikipedia API"]
            },
            {
                "name": "OUTPUT_DEST",
                "label": "Tujuan Laporan",
                "type": "select",
                "options": ["Notion Page", "Google Docs", "Email Digest", "Slack Channel"]
            }
        ]
    },
    "KOL-AUTO-005": {
        ...
        "components": [
            {
                ...
                "type": "select",
                "options": ["Stripe Webhook", "PayPal IPN", "Transfer Manual (Form Upload Bukti)", "Xendit Invoice"]
            },
            {
                "name": "ONBOARDING_ASSETS",
                "label": "Aset yang Disiapkan",
                "type": "multiselect",
                "options": ["Folder Google Drive/Dropbox", "Board Trello/ClickUp", "Channel Slack/Discord", "Akun Login Portal"]
            },
            {
                "name": "CONTRACT_SIGN",
                "label": "Tanda Tangan Kontrak",
                "type": "select",
                "options": ["Tidak Perlu", "DocuSign / PandaDoc (Auto-send)", "E-sign PDF sederhana"]
            }
        ]
    },
    "KOL-AUTO-006": {
        ...
        "components": [
            {
                ...
                "type": "select",
                "options": ["Harga Produk E-commerce", "Artikel Blog Baru", "Ketersediaan Stok", "Jumlah Follower Sosmed"]
            },
            {
                "name": "SCRAPING_METHOD",
                "label": "Metode Scraping",
                "type": "select",
                "options": ["HTTP Request Sederhana (N8n/Make)", "Apify Actor", "Browserless.io (Puppeteer)", "ScrapingBee"]
            },
            {
                "name": "CHANGE_TYPE",
                "label": "Kondisi Trigger Alert",
                "type": "select",
                "options": ["Harga Turun", "Harga Berubah (Naik/Turun)", "Ada Keyword Tertentu", "Stok Habis"]
            }
        ]
    },
    "KOL-AUTO-007": {
        ...
        "components": [
            {
                ...
                "type": "select",
                "options": ["Zoom Webinar Registration", "Eventbrite", "Google Form / Tally", "Landing Page Custom"]
            },
            {
                "name": "REMINDER_CHANNELS",
                "label": "Channel Reminder",
                "type": "multiselect",
                "options": ["WhatsApp (Paling Efektif)", "Email Blast", "SMS", "Calendar Invite (.ics)"]
            },
            {
                "name": "CRITICAL_TIMING",
                "label": "Waktu Reminder Penting",
                "type": "multiselect",
                "options": ["H-24 Jam", "H-1 Jam", "H-15 Menit (Live Now)"]
            }
        ]
    },
    "KOL-AUTO-008": {
        ...
        "components": [
            ...
            },
            {
                ...
                "type": "select",
                "options": ["Basic (Stop & Log)", "Retry (Coba 3x)", "Advanced (Ignore & Alert via Slack)", "Rollback Data"]
            }
        ]
    }
}

print("Mulai Menulis 8 Framework Workflow Otomasi (N8n/Make/Zapier)...\n")
...
print("\nSelesai! Semua framework kini adalah Blueprint Teknis Workflow Otomasi.")
